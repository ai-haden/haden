...
namespace Haden.Library.DecisionTree
{
    ...
    public partial class TreeNode
    {
        ...
        /// <summary>
        /// Classifies the specified data vector.
        /// </summary>
        /// <param name="dataVector">The data vector.</param>
        /// <param name="byProbability">if set to <c>true</c> [by probability].</param>
        /// <returns></returns>
        ...
        {
            double r = random.NextDouble() * labels.Sum(p => p.ExpectedReward); // Random value between 0 and the sum of expected rewards
    ...
    public partial class TreeNode
    {
        ...
        /// <summary>
        /// Converts to htmltree.
        /// </summary>
        /// <param name="treeDisplaySettings">The tree display settings.</param>
