...
namespace Haden.Library
{
    ...
    public class State
    {
        ...
        /// <summary>
        /// The impurity represents the uniformity of the experienced label distribution. 
        /// <remarks>
        /// Note: it is modified to be relative to the max possible gini impurity for the given number of labels.
        ///     0 => only one label
        ...
        {
            // Add to list of features. Copy to prevent storing derived classes such as FeatureValuePairWithImportance.
            FeatureValuePair fvp = new FeatureValuePair(theFeature.Name, theFeature.Value);
            Features.Add(fvp);
        ...
        private void FeatureOnRemoveSelf(object sender, EventArgs e)
        {
        ...
        private void QueryOnRemoveSelf(object sender, EventArgs e)
        {
        ...
        private void LabelOnRemoveSelf(object sender, EventArgs e)
        {
