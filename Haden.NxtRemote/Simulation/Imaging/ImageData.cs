...
namespace Haden.NXTRemote.Simulation.Imaging
{
    /// <summary>
    ...
    public class ImageData : IDisposable
    {
        ...
        public void FromBitmap(Bitmap srcBmp)
        {
            ...
            BitmapData bmpData = srcBmp.LockBits(new Rectangle(0, 0, w, h),
        ...
        public Bitmap ToBitmap()
        {
            ...
            for (int y = 0; y < height; y++)
            {
                ...
                {
                    if (_blue != null) rgbValues[i] = CheckArray(_blue, x, y) ? _blue[x, y] : (byte)0;
                    if (_green != null) rgbValues[i + 1] = CheckArray(_green, x, y) ? _green[x, y] : (byte)0;
                    if (_red != null) rgbValues[i + 2] = CheckArray(_red, x, y) ? _red[x, y] : (byte)0;
                    if (_alpha != null) rgbValues[i + 3] = CheckArray(_alpha, x, y) ? _alpha[x, y] : (byte)255;
                    i += 4;
                }
                i += offset;
            }
