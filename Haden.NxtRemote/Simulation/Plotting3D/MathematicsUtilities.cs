...
{
    static class MathematicsUtilities
    {
        ...
        public static double GetProjectedLength(double tiltAngle, double depth)
        {
        ...
        public static double FindInnerAnglePhase2(double outerAngle, double depth, double distanceBetween)
        {
