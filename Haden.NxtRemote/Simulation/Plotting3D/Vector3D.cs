...
namespace Haden.NXTRemote.Simulation.Plotting3D
{
    ...
    public struct Vector3D : IEquatable<Vector3D>
    {
        ...
        public double Length
        {
            get
            {
                double doubleX = _endPoint.X;
                double doubleY = _endPoint.Y;
                double doubleZ = _endPoint.Z;
        ...
        {
            return _endPoint.ApproximatelyEquals(other._endPoint);
        }
        /// <summary>
        /// Returns a string representation of the vector's endpoint in [X,Y,Z] format, 
        ...
        {
            return new Vector3D(
                (float)(Y * (double)a.Z - Z * (double)a.Y),
                (float)(Z * (double)a.X - X * (double)a.Z),
                (float)(X * (double)a.Y - (double)Y * a.X)
                );
        }
        /// <summary>
        ...
        public static Vector3D operator *(Vector3D a, double b)
        {
            ...
            return new Vector3D((float)(a.X * b), (float)(a.Y * b), (float)(a.Z * b));
        }
        /// <summary>
        /// Multiplying a vector by a scalar results in a vector with the same (or exactly opposite)
        /// direction as the original, but with a different length.
        ...
        {
            return new Vector3D(a._endPoint + b);
        }
        /// <summary>
